          ...
          {ssoLoading ? (
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="relative flex items-center justify-center my-1.5">
                <div className="border-t border-[#2F3130] w-full" />
                <span className="absolute bg-black px-2 text-[10px] uppercase text-stone-500 font-sans">
                  或者使用第三方登录
                </span>
              </div>
              ...
              <div className="grid grid-cols-3 gap-2 pt-1">
                <button
                  type="button"
                  onClick={() => {
                    setUserEmail('google-test-user@gmail.com');
                    setLoggedIn(true);
                    showNotification('🎉 成功通过 Google 联合账户授权登录！', 'success');
                  }}
                  className="flex items-center justify-center gap-1.5 py-2 px-1.5 bg-[#161616] hover:bg-[#222] border border-[#2F3130] hover:border-stone-600 rounded text-[10px] font-sans text-stone-300 hover:text-white transition-all cursor-pointer truncate"
                  title="Google 登录"
                >
                ...
                <button
                  type="button"
                  onClick={() => {
                    setUserEmail('x-test-user@x.com');
                    setLoggedIn(true);
                    showNotification('🎉 成功通过 X (Twitter) 联合账户授权登录！', 'success');
                  }}
                  className="flex items-center justify-center gap-1.5 py-2 px-1.5 bg-[#161616] hover:bg-[#222] border border-[#2F3130] hover:border-stone-600 rounded text-[10px] font-sans text-stone-300 hover:text-white transition-all cursor-pointer truncate"
                  title="X (Twitter) 登录"
                >
                ...
                <button
                  type="button"
                  onClick={() => {
                    setUserEmail('github-test-user@github.com');
                    setLoggedIn(true);
                    showNotification('🎉 成功通过 GitHub 联合账户授权登录！', 'success');
                  }}
                  className="flex items-center justify-center gap-1.5 py-2 px-1.5 bg-[#161616] hover:bg-[#222] border border-[#2F3130] hover:border-stone-600 rounded text-[10px] font-sans text-stone-300 hover:text-white transition-all cursor-pointer truncate"
                  title="GitHub 登录"
                >
